...
<head>
	...
	<link rel="icon" href="/cruton/images/favicon.png">

	<link rel="stylesheet" href="/cruton/libs/bootstrap/css/bootstrap-reboot.min.css">
	<link rel="stylesheet" href="/cruton/libs/bootstrap/css/bootstrap-grid.min.css">
	<link rel="stylesheet" href="/cruton/libs/bootstrap/css/bootstrap.min.css">
	<link rel="stylesheet" href="/cruton/libs/swiper/swiper-bundle.min.css">

	<link rel="stylesheet" href="/cruton/css/main.css">
	<link rel="stylesheet" href="/cruton/css/media.css">
	...
	<script src="/cruton/libs/swiper/swiper-bundle.min.js" defer></script>
	<script src="/cruton/js/common.js" defer></script>
	<script src="/cruton/js/jquery.min.js" defer></script>
		<script src="/cruton/js/bootstrap.min.js" defer></script>
		<script src="/cruton/js/main.js" defer></script>
		<script src="/cruton/js/actions.js" defer></script>
    <script src="/cruton/js/script.js" defer></script>
			...
			<div class="row align-items-center">
				<div class="col-lg-5 col">
					<div class="d-flex align-items-center">
						<a href="/cruton" class="logo">
							<img src="/cruton/images/logo.png" loading="lazy">
						</a>
				...
				<div class="col-4 d-lg-block d-none">
					<nav>
						<ul>
							<li>
								<a href="/cruton/store.php?filter=Услуги#">
							...
							<li>
								<a href="/cruton/store.php?filter=Автомобили#">
							...
							<li>
								<a href="/cruton/store.php?filter=Товары#">
...
<g>
	...
	<path d="M316.981,13.155h-170c-5.522,0-10,4.477-10,10v45.504c0,5.523,4.478,10,10,10h3.735v96.623c0,5.523,4.477,10,10,10h142.526
		...
		C261.016,98.828,257.427,102.417,253.016,102.417z M306.981,58.658h-3.738H160.716h-3.735V33.155h150V58.658z"/>
							...
							<li>
								<a href="/cruton/information/tariffs.php">
								<svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path
					...
					<div class="align-items-center justify-content-end d-lg-flex d-none">
						<div class="dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
								<a class="dropdown-item" href="/cruton/information/faq.php">Вопросы и ответы</a>
								<a class="dropdown-item" href="/cruton/information/partners.php">Партнеры</a>
								<a class="dropdown-item" href="/cruton/information/about.php">О компании</a>
								<a class="dropdown-item" href="/cruton/information/tariffs.php">Тарифы</a>
								<a class="dropdown-item" href="/cruton/information/contacts.php">Контакты</a>
							</div>
						</div>
						<?php include "db.php";
							if (isset ($_SESSION["uid"])) {
								...
								echo '
								<a href="/cruton/profile.php" class="dropdown btn" >Профиль</a>
								<a href="/cruton/logout.php" class="link-btn ml-3">Выйти</a>
								';
